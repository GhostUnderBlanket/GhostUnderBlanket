...
<div align="center">
  ...
  [![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&duration=3000&pause=1000&color=56D364&center=true&vCenter=true&width=670&lines=Hey+there%2C+world!+I'm+BlanketGhost.;This+GitHub+dev+log+is+where+I+share+my+creations.;Here+you'll+find+what+I'm+learning+on+my+journey.)](https://git.io/typing-svg)
</div>

<!-- Info -->
```yaml
I'm a full-time game developer, always cooking up something fun in the digital realm.
Wanna peek at my dev stats? Here ya go

---
## Languages I Dig:
- Unity: write almost every day
- CSharp: my main language
- Lua: still getting the hang of it

---
## My Go-To Gear:
- Unity Engine: duh!
- Rider: my trusty IDE
- VS Code: for quick edits and chill vibes
- GitHub: where my code lives
- PlasticSCM: version control wizardry

---
## When I'm Not Coding, You Can Find Me:
- Gaming: obviously, I'm a dev after all!
- Modding: because why play by the rules, right?
- Anime: for when I need to escape reality
- Manga: gotta know what happens next!

---
## Wanna connect? Here's where to find me:
- GitHub: [GhostUnderBlanket] (Come say hi!)
- Nexus: [I3lanketGhost] (Check out my modding adventures!)
- Discord: [i3lanketghost] (Let's chat about anything game dev!)
```
...
<div align="center">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://github.com/GhostUnderBlanket/GhostUnderBlanket/blob/output/github-contribution-grid-snake-dark.svg" />
      <source media="(prefers-color-scheme: light)" srcset="https://github.com/GhostUnderBlanket/GhostUnderBlanket/blob/output/github-contribution-grid-snake.svg" />
      <img alt="github contribution grid snake animation" src="https://github.com/GhostUnderBlanket/GhostUnderBlanket/blob/output/github-contribution-grid-snake.svg" />
    </picture>
</div>
